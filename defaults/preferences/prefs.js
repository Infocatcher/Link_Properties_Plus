...
pref("extensions.linkPropertiesPlus.showHeadersTips", true);
...
// For button inside Australis menu-button:
pref("extensions.linkPropertiesPlus.dnd.autoOpenPanel", true);
